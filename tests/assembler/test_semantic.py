...
class OperandResolverTest(unittest.TestCase):
    ...
    def test_resolve_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.REGISTER
        )
    ...
    def test_resolve_index_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.INDEX_REGISTER
        )
    ...
    def test_resolve_delay_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.DELAY_REGISTER
        )
    ...
    def test_resolve_sound_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.SOUND_REGISTER
        )
    ...
    def test_resolve_font_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.FONT_REGISTER
        )
    ...
    def test_resolve_bcd_register(self) -> None:
        ...
        operand = self.resolver.resolve(
            expression,
            AssemblerOperandType.BCD_REGISTER
        )
...
class InstructionResolverTest(unittest.TestCase):
    ...
    def test_resolve_add_vx_byte(self) -> None:
        instruction = InstructionNode(
            ...
            operands=(
                IdentifierExpression(name="V3", location=self.location),
                LiteralExpression(value=5, location=self.location)
            ),
            location=self.location
        )
    ...
    def test_resolve_add_vx_vy(self) -> None:
        instruction = InstructionNode(
            ...
            operands=(
                IdentifierExpression(name="V3", location=self.location),
                IdentifierExpression(name="V5", location=self.location)
            ),
            location=self.location
        )
    ...
    def test_resolve_add_i_vx(self) -> None:
        instruction = InstructionNode(
            mnemonic="ADD",
            operands=(
                IdentifierExpression(name="I", location=self.location),
                IdentifierExpression(name="V3", location=self.location)
            ),
            location=self.location
        )
    ...
    def test_resolve_jp_address_symbol(self) -> None:
        ...
        instruction = InstructionNode(
            mnemonic="JP",
            operands=(
                IdentifierExpression(name="LOOP", location=self.location),
            ),
            location=self.location
        )
